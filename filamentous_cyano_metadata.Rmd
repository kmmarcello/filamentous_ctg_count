...
temp_organism <- filament_cyanos %>% 
  ...
  theme(legend.position = "right",
        text = element_text(size=6),
        axis.text.x = element_text(angle = 60, hjust=1))+
  labs(title = "Environmental temperature for Cyanobacteria Species",x = "Temperature C", y = "Organism")

ggsave("figures/fil_temp_heatmap.png", width=10, height=6, plot = fil_heatmap, dpi = 200)
